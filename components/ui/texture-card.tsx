...
TextureCardStyled.displayName = "TextureCardStyled"// Allows for global css overrides and theme support - similar to shad ny
...
const TextureCardContent = React.forwardRef<
  ...
  React.HTMLAttributes<HTMLDivElement>
>(({ className, ...props }, ref) => (
  <div ref={ref} className={ny("px-6 py-4", className)} {...props} />
))
